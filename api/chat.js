...
`;
        ...
        // Apuntamos directamente al modelo Gemini 3.5 Flash oficial de la API de Google
        const response = await fetch(`https://generativelanguage.googleapis.com/v1/models/gemini-3.5-flash:generateContent?key=${geminiApiKey.trim()}`, {
            method: 'POST',
